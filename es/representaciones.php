...
<html lang="en">
  <head>
    <title>LOS TRIGALES - Representaciones</title>
    ...
    <section>
      <div class="container">
        ...
        <div class="about-container">
          <p>MELON empresa líder en Chile en la producción de cemento, hormigones, áridos y morteros con una trayectoria de 106 años es representada en Paraguay por LOS TRIGALES.</p>
          <p>Se importa y comercializa lo cemento bajo respaldo de INTN que garantiza seguridad de los productos a través de la certificación ONC.</p>
          <p>Conozca más de Melón en <a href="http://www.melon.cl/">www.melon.cl</a></p>
        </div>
        <div class="about-img">
          <div data-options="{&quot;animation&quot;: &quot;fade&quot;, &quot;slideshowSpeed&quot;: &quot;2000&quot;,  &quot;animationSpeed&quot;: &quot;600&quot;, &quot;controlNav&quot;: true, &quot;directionNav&quot;: true}" class="flexslider nav-inside control-nav-dark">
            <ul class="slides">
              <li><img src="../images/lostrigales/representaciones-1.jpg" alt=""></li>
              <li><img src="../images/lostrigales/representaciones-2.jpg" alt=""></li>
              <li><img src="../images/lostrigales/representaciones-3.jpg" alt=""></li>
              <li><img src="../images/lostrigales/representaciones-4.jpg" alt=""></li>
            </ul>
          </div>
        </div>
      </div>
