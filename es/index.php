      ...
      <div id="home-slider" class="flexslider kenburn">
        ...
        <div class="Marquee">
          <div class="Marquee-content">
            <div class="Marquee-tag">Valoramos su confianza...</div>
            <div class="Marquee-tag">Dinamismo e innovación...</div>
            <div class="Marquee-tag">Soluciones integrales...</div>
            <div class="Marquee-tag">Somos una opción diferente...</div>
            <div class="Marquee-tag">Valoramos su confianza...</div>
            <div class="Marquee-tag">Dinamismo e innovación...</div>
            <div class="Marquee-tag">Soluciones integrales...</div>
            <div class="Marquee-tag">Somos una opción diferente...</div>
