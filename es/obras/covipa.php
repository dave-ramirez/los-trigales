        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Camineros de la Región Oriental - San Pedro - Tramo 17 - ruta 3 - Tacuati.</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Camineros de la Región Oriental - San Pedro - Tramo 17 - ruta 3 - Tacuati.</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Subcontrato de Obra para la Construcción de Pavimento Tipo Empedrado en varios tramos, excavación, terraplén, cordón y banquina
                </div>
