        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Red Vial Nacional - Paquete 3 - Lote 1 - Contrato SG Ministro Nº 167/2015</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Red Vial Nacional - Paquete 3 - Lote 1 - Contrato SG Ministro Nº 167/2015</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Subcontrato de Obra para la Pavimentación de tramos alimentadores de la Red Vial Nacional. Movimiento de Suelos, pavimentos, drenes, obras complementarias
                </p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Empresa</h4>
                        <h5>Consorcio Pavimento Urbano</h5>
                    </div>
                    <div>
                        <h4>Lugar</h4>
                        <h5>MARIANO ROQUE ALONSO - LIMPIO</h5>
                    </div>
                    <div>
                        <h4>Duracion</h4>
                        <h5>21 Meses</h5>
