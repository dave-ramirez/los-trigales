        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>UNA - Sede Santa Rosa del Aguaray - Departamento de San Pedro   </h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>UNA - Sede Santa Rosa del Aguaray - Departamento de San Pedro   </h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Construcción del Edificio de la Facultad de Ciencias Médicas-UNA. Construcción de Edificio
                <p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Empresa</h4>
                        <h5>Facultad de Ciencias Médicas - Universidad Nacional de Asunción</h5>
                    </div>
                    <div>
                        <h4>Lugar</h4>
                        <h5>SANTA ROSA DEL AGUARAY</h5>
                    </div>
                    <div>
                        <h4>Duracion</h4>
                        <h5>20 Meses</h5>
