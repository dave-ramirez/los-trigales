        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Intersección de la Avda. Madame Lynch y Avda. Aviadores del Chaco.</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Intersección de la Avda. Madame Lynch y Avda. Aviadores del Chaco.</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Subcontrato de Obra para la Construcción del Paso a Desnivel. Terraplén, Pedraplén, carpeta de concreto asfáltico, base granular, riego de liga, imprimación.
                </p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Empresa</h4>
                        <h5>Corsan Corviam Construcción SA</h5>
                    </div>
                    <div>
                        <h4>Lugar</h4>
                        <h5>ASUNCION</h5>
