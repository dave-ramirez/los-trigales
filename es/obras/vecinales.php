        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Rehabilitación de Tramos de Caminos Vecinales  (CONSORCIO M & T - LT)</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Rehabilitación de Tramos de Caminos Vecinales  (CONSORCIO M & T - LT)</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Contrato S.G. Ministro Nº 464/16-Departamentos de San Pedro, Caaguazu  y Caazapa - LOTE 1 - CAAGUAZU"  enripiado, alcantarillado, puente, entre otros
                <p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Lugar</h4>
                        <h5>3 DE FEBRERO - DPTO DE CAAGUAZU</h5>
                    </div>
                    <div>
                        <h4>Duracion</h4>
                        <h5>23 Meses</h5>
