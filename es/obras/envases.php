        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Obras exteriores en playa de circulación y otros trabajos.</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Obras exteriores en playa de circulación y otros trabajos.</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Movimiento de suelo, pavimento de hormigón armado, trabajos varios de hormigón armado y otros.
                </p>
                </div>
