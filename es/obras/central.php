        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>"Mejoramiento Vial de la  Avenida Médicos del Chaco"</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>"Mejoramiento Vial de la  Avenida Médicos del Chaco"</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Trabajos de empedrado y Pavimentación Asfáltica
                <p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Lugar</h4>
                        <h5>Aregua - Capiata - J A Saldivar </h5>
                    </div>
                    <div>
                        <h4>Duracion</h4>
                        <h5>4 meses proyecto - 20 meses ejecución de obras</h5>
                    </div>
                    <div>
                        <h4>Situacion Actual</h4>
                        <h5>En etapa de elaboración de proyecto</h5>
                    </div>
                </div>
            </div>
          </div>
