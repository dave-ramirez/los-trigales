...
<html lang="en">
  <head>
    <title>LOS TRIGALES - Constructora</title>
  ...
  <body>
    ...
    <section class="page-title parallax">
      <div data-parallax="scroll" data-image-src="../../images/obras/super_viaducto/13.jpg" class="parallax-bg"></div>
      <div class="parallax-overlay">
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>AD REFERENDUM a la Reprogramación Presupuestaria - LOTE Nº 02 - ID Nº 315.021. (CONSORCIO PILCOMAYO)</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="gallery">
      <div class="container">
        <div class="gallery-container">
          ...
          <iframe width="100%" height="100%" src="https://www.youtube.com/embed/nZmY642yMns" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
          </div> -->
          <div class="work-details">
            <div class="detail-title">
                    <h3>AD REFERENDUM a la Reprogramación Presupuestaria - LOTE Nº 02 - ID Nº 315.021. (CONSORCIO PILCOMAYO)</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Ejecución de Obras para la Ampliación, Profundización y Optimización de los Canales de Captación y Conducción  de las Aguas del Rio Pilcomayo en Territorio Paraguayo. Remoción de sedimentos, limpieza y profundización de canal
                </p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Empresa</h4>
                        <h5>Ministerio de Obras Públicas y Comunicaciones</h5>
                    </div>
                    <div>
                        <h4>Lugar</h4>
                        <h5>CHACO PARAGUAYO</h5>
                    </div>
                    <div>
                        <h4>Duracion</h4>
                        <h5>6 Meses</h5>
