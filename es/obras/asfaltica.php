        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Regularización Asfáltica - Compañía Salado.</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Regularización Asfáltica - Compañía Salado.</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Regularización Asfáltica sobre empedrado en la Riego de liga, cordón de hormigón, carpeta de concreto asfáltico, señalización vertical y horizontal.
                </p>
                </div>
