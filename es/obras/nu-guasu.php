        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Autopista Ñu Guasu - Asunción - Luque - Tramo 2 - 6,3 km</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Autopista Ñu Guasu - Asunción - Luque - Tramo 2 - 6,3 km</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Subcontrato de Obra para la Construcción de Pavimento de concreto asfáltico, riego de liga,excavación, terraplén, pedraplén, base y subbase
                </p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Empresa</h4>
                        <h5>Consorcio Las Residentas</h5>
                    </div>
                    <div>
                        <h4>Lugar</h4>
                        <h5>LUQUE</h5>
