        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Ruta Nº 3 - Gral Elizardo Aquino, tramo Bella Vista Norte - Empalme Ruta 5 - Departamento de Amambay y Concepción.</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Ruta Nº 3 - Gral Elizardo Aquino, tramo Bella Vista Norte - Empalme Ruta 5 - Departamento de Amambay y Concepción.</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                     Subcontrato de Obra para el Mejoramiento de ruta Nº 3. Terraplén, excavación, riego de imprimación, excavación en roca, suelo cemento, base y subbase                </p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Empresa</h4>
                        <h5>Consorcio General Aquino </h5>
                    </div>
                    <div>
                        <h4>Lugar</h4>
                        <h5>BELLA VISTA NORTE</h5>
                    </div>
                    <div>
                        <h4>Duracion</h4>
                        <h5>35 Meses</h5>
