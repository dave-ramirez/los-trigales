        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Mejoramiento de Franja de Dominio de Carreteras por Niveles de Servicios</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Mejoramiento de Franja de Dominio de Carreteras por Niveles de Servicios</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Contrato S.G. Ministro Nº 525/2017 " Limpieza de Franja de Dominio
                <p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Empresa</h4>
                        <h5>Ministerio de Obras Publicas y Comunicaciones (MOPC)</h5>
                    </div>
                    <div>
                        <h4>Lugar</h4>
                        <h5>LOTE 10: PARAGUARI - VILLARRICA PARAGUARI YBYTYMI - LOTE 14: RUTA 1 PARAGUARI ( DESVIO A VILLARRICA) FIN ZONA URBANA DE QUIINDY ( INICIO DE CICLOVIA) - LOTE 31: RUTA 9 KM 21 A KM 121</h5>
                    </div>
                    <div>
                        <h4>Duracion</h4>
                        <h5>12 Meses</h5>
