        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>"Mejoramiento Vial de las Avenidas Primer Presidente, Julio Correa y Santísima Trinidad" - LOTE 2</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>"Mejoramiento Vial de las Avenidas Primer Presidente, Julio Correa y Santísima Trinidad" - LOTE 2</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Contrato UOC 3 Nº 06/2017 . Mejoramiento Vial. Trabajos de Pavimentación asfáltica
                <p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Empresa</h4>
                        <h5>Municipalidad de Asunción</h5>
                    </div>
                    <div>
                        <h4>Lugar</h4>
                        <h5>ASUNCION</h5>
