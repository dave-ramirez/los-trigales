        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Tramo San Juan Nepomuceno - Ruta Nº 06  comprendido entre las progresivas 40+000 a 50+000</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Tramo San Juan Nepomuceno - Ruta Nº 06  comprendido entre las progresivas 40+000 a 50+000</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                  Subcontrato de Obra para la Rehabilitación, Construcción de Asfalto, puentes, alcantarillados
                <p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Empresa</h4>
                        <h5>CDD CONSTRUCCIONES S.A.</h5>
                    </div>
                    <div>
                        <h4>Lugar</h4>
                        <h5>TAVAI - DPTO DE CAAZAPA</h5>
                    </div>
                    <div>
                        <h4>Duracion</h4>
                        <h5>24 Meses</h5>
