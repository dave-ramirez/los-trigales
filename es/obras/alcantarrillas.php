        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Alcatarillas Celulares y Tubulares en todo el Territorio Nacional</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Alcatarillas Celulares y Tubulares en todo el Territorio Nacional</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                Contrato S.G. Ministro Nº 359/2017. Construcción de Alcantarillas
                <p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Lugar</h4>
                        <h5>CAAGUAZU - CENTRAL - CORDILLERA - GUAIRA  -  PARAGUARI</h5>
                    </div>
                    <div>
                        <h4>Duracion</h4>
                        <h5>12 Meses</h5>
