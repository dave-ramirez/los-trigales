        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Departamentos de la Región Oriental -  LOTES 5, 6 Y 8. (CONSORCIO LT - BLACK)</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Departamentos de la Región Oriental -  LOTES 5, 6 Y 8. (CONSORCIO LT - BLACK)</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                Mejoramiento de la Transitabilidad de Caminos no Pavimentados. Abovedamiento de calzada, carga y conformación de suelo
                </p>
                </div>
