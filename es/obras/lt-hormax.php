...
<html lang="en">
  ...
  <body>
    ...
    <section class="page-title parallax">
      <div data-parallax="scroll" data-image-src="../../images/lostrigales/lt-hormax-2.jpg" class="parallax-bg"></div>
      ...
      <div class="container">
        <div class="gallery-container">
          <div style="height: 600px; margin-top: 40px;">
            <iframe width="100%" height="100%"  src="https://www.youtube.com/embed/tQlxzPNtX7A" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> 
          </div>
        </div>
      </div>
    </section>
