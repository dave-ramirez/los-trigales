...
<html lang="en">
  ...
  <body>
    ...
    <section class="page-title parallax">
      <div data-parallax="scroll" data-image-src="../../images/lostrigales/paraguay-es.png" class="parallax-bg"></div>
    ...
    <section id="gallery">
      <div class="container">
        <div class="gallery-container">
          <div style="height: 600px; margin-top: 40px;" class="lang" key="video">
