        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Pavimento Zeballos Cue - Barrio Zeballos Cue - Ciudad de Asunción</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Pavimento Zeballos Cue - Barrio Zeballos Cue - Ciudad de Asunción</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Construcción de Pavimento Tipo Asfáltico sobre empedrado y sobre terraplén. Riego de liga, carpeta asfáltica, imprimación, señalización, desague pluvial, badén entre otros.
                </p>
                </div>
                <div class="date-content">
                    ...
                    <div>
                        <h4>Empresa</h4>
                        <h5>Itaipu Binacional</h5>
                    </div>
                    <div>
                        <h4>Lugar</h4>
                        <h5>BARRIO ZEBALLOS CUE - ASUNCION</h5>
                    </div>
                    <div>
                        <h4>Duracion</h4>
                        <h5>15 Meses</h5>
