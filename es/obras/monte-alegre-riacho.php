        ...
        <div class="centrize">
          <div class="v-center" style="text-align:center;">
            <div class="titulo-work">
                <h2>Complejo Terminal Occidental S.A. ( TOSA)  - Riacho Cabañas.</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="gallery-container">
          ...
          <div class="work-details">
            <div class="detail-title">
                    <h3>Complejo Terminal Occidental S.A. ( TOSA)  - Riacho Cabañas.</h3>
            </div>
            <div class="detail-content">
                <div class="detail-text">
                <p>
                    Pavimentación Asfáltica  del Acceso y Calles Interiores, , riego de liga, riego de imprimación, excavación, entre otras.
                </p>
                </div>
